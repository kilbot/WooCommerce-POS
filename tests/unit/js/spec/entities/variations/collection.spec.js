describe('entities/variations/collection.js', function () {
  ...
  var Variable = require('entities/products/models/variable');
  var variations;

  beforeEach(function(){
    var variableProduct = _.find(dummy, { id: 40 });
    variations = new Collection( variableProduct.variations, { parent: new Variable(variableProduct) } );
  });
  ...
  //   variations.parent.getVariationOptions().should.eql([{
  //     name: 'Color',
  //     options: [ 'Black', 'Blue' ]
  //   }]);
  // });
  ...
  //   });
  //
  //   collection.parent.getVariationOptions().should.eql([
