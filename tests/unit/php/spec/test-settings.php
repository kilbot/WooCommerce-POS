...
class SettingsTest extends WP_UnitTestCase {
  ...
  public function setUp(){
    $this->db_version_option = WC_POS_Settings::DB_PREFIX . 'db_version';
    $this->idb_version_option = WC_POS_Settings::DB_PREFIX . 'idb_version';
  ...
  public function test_get_db_version(){
    ...
    // should init with 0
    $this->assertEquals( 0, WC_POS_Settings::get_db_version() );

    // bump versions
    WC_POS_Settings::bump_versions();
    $this->assertEquals( WC_POS_VERSION, WC_POS_Settings::get_db_version() );
  }

  public function test_get_idb_version(){

    // should init with 1
    $this->assertEquals( 1, WC_POS_Settings::get_idb_version() );
