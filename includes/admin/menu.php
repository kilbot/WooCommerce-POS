...
class Menu {
  ...
  public function admin_menu() {
    ...
    // if User can neither manage nor access POS
    // > no POS menu
    if(!current_user_can('manage_woocommerce_pos')
      && !current_user_can('access_woocommerce_pos')){
      return;
    }

    // User who can access_woocommerce_pos
    // can view POS Menu in WP Admin
    // with only 'Upgrade to Pro' & 'View POS' entries
    ...
    $pos_submenu[0][2] = 'upgrade-to-pro';
