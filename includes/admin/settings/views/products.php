...
<div id="wc_pos-product-tabs">
  <table class="widefat wc_pos-form-table-horizontal sortable" cellspacing="0">
    ...
    <tbody>
      <tr>
        <td style="vertical-align:middle;"><span class="dashicons dashicons-menu"></span><input type="hidden" data-name="order"></td>
    ...
    <tfoot>
      <tr>
        <td colspan="4"><a class="button-secondary" href="#" data-action="add-tab"><?php _e('Add Tab', 'woocommerce-pos'); ?></a></td>
      </tr>
    </tfoot>
  </table>
</div>