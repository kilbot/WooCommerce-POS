...
<p>
	<?php printf( __( 'For more information please visit <a href="%1$s" target="_blank">%1$s</a>', 'woocommerce-pos' ), wcpos_doc_url( 'how-to/configure/receipts.html' ) ); ?>
</p>
	...
	<tr class="print_receipt_method">
		...
		<td>
			...
			<div id="network-options">
				<p>
					<label for="network_options"><?php _e( 'Printer URL', 'woocommerce-pos' ); ?>:</label> <input
						id="network_options" name="network_options" type="text" style="width:400px">
				</p>
				<p>
					<img src="<?php echo WC()->plugin_url(); ?>/assets/images/help.png" height="16" width="16"
					     style="float:left;margin: 3px 5px 10px 0;">
					<small><?php _e( 'Example Printer URL for Epson TM Printers', 'woocommerce-pos' ) ?>:
						http://192.168.192.168/cgi-bin/epos/service.cgi?devid=local_printer&timeout=10000
					</small>
				</p>
			</div>
			<div id="qz-tray-options">
				<p>
					<a id="qz_tray_options" class="button" href="https://demo.qz.io/" target="_blank">Open QZ Tray
						Demo</a>
				</p>
			</div>
		</td>
