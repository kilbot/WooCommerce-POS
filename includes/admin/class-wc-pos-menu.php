...
class WC_POS_Admin_Menu {
	...
	private $menu_slug = 'woocommerce-pos';
	...
	public function __construct() {
		...
		add_filter( 'woocommerce_pos_screen_ids', array( $this, 'woocommerce_pos_screen_ids' ) );
	}
	...
	public function admin_menu() {
		...
		$submenu[$this->menu_slug][0][0] = __( 'Upgrade to Pro', 'woocommerce-pos' );
		$submenu[$this->menu_slug][500] = array( __( 'View POS', 'woocommerce-pos' ), 'manage_woocommerce_pos' , wc_pos_url() );
	}

	public function woocommerce_pos_screen_ids( $ids ) {
