...
class Page {
	...
	public function enqueue_admin_styles() {
		wp_enqueue_style(
			\WCPOS\PLUGIN_NAME . '-admin',
			\WCPOS\PLUGIN_URL . 'assets/css/admin.min.css',
			null,
			\WCPOS\VERSION
		);
	}
	...
	public function admin_print_scripts() {
		echo '<script>var wcpos_admin = "' . $this->wcpos_adminpage . '";</script>';
	}
	...
	static public function bump_versions() {
		self::update_option( self::DB_PREFIX . 'db_version', \WCPOS\VERSION );
