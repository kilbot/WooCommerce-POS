	...
	<li class="list-row">
		...
		<div class="message">
			...
			foreach ( $buttons as $button ):
				...
				?>
				<a href="<?php echo esc_url( $href ); ?>" <?php echo $action; ?>
				   class="btn btn-default"><?php echo $prompt; ?></a>
			<?php endforeach; ?>
		</div>
	</li>
<?php endforeach; ?>

<li class="list-row sub-heading">
	<div><?php _e( 'Local Storage', 'woocommerce-pos' ); ?></div>
</li>
