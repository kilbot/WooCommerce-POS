<li class="list-row">
	<div class="label"><?php /* translators: wordpress */
		_e( 'Name' ); ?>:
	</div>
...
<li class="list-row">
	...
	<div class="input" data-name="message"
	     placeholder="<?php _e( 'Describe your problem here ...', 'woocommerce-pos' ) ?>" contenteditable></div>
</li>
