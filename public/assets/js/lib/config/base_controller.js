define(['app', 'backbone.marionette'], function(POS, Marionette){
	...
	POS.Controller.Base = Marionette.Controller.extend({
		...
		constructor: function(options) {
			options || (options = {});
			this.region = options.region || POS.globalChannel.request('default:region');

			this._instance_id = _.uniqueId('controller');
			POS.globalChannel.command( 'register:instance', this, this._instance_id );
