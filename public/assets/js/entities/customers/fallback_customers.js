define(['app', 'paginator'], function(POS, PageableCollection){
	...
	POS.module('Entities', function(Entities, POS, Backbone, Marionette, $, _){
		...
		Entities.FallbackCustomer = Backbone.Model.extend();

		Entities.FallbackCustomerCollection = Backbone.PageableCollection.extend({
			url: pos_params.wc_api_url + 'customers',
			model: Entities.FallbackCustomer,

			initialize: function(models, options) {
				// this.on('all', function(e) { console.log("Customer Collection event: " + e); }); // debug
